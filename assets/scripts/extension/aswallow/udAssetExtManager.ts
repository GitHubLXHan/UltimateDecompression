import { UdDragonBoneParser, UdDragonBoneAtlasParser } from "./udDragonBoneParser";
import { UdPlistParser } from "./udPlistParser";
import { UdSpineParser } from "./udSpineParser";
import { UdTiledMapParser } from "./udTiledMapParser";
...
export class UdAssetExtMgr implements aswallow.IExtAssetManager {
    ...
    constructor() {
        this.registAssetParser(new UdDragonBoneParser());
        this.registAssetParser(new UdDragonBoneAtlasParser());
        this.registAssetParser(new UdPlistParser());
        this.registAssetParser(new UdSpineParser());
        this.registAssetParser(new UdTiledMapParser());
    }
    /**
...
aswallow.extAssetMgr = new UdAssetExtMgr();