...
import { ListenerHandlerVo } from "../eventListener/ListenerHandlerVo";
import { BaseLog } from "../log/BaseLog";
import { PoolMgr } from "../pool/PoolMgr";
import { IProfiler } from "./IProfiler";
import { Monitor } from "./Monitor";

export abstract class BaseProfiler<T extends string | number> extends BaseLog implements IProfiler {
    ...
    abstract memoryInfo(): { size: number, tips: string };

    abstract freeMemory(): number;
