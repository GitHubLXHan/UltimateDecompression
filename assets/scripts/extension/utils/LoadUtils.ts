...
export class LoadUtils {
    ...
    //     if (iconPath == null) {
    //         LoadMgr.Ins.LoadRes(path, LoadUtils.IconLoadComplete, LoadPriorityType.Other, sprite, icon);
    //     }
    //     else {
    //         LoadUtils.IconLoadComplete([sprite, icon]);
    //     }
    // }   
     ...
     */
     public static getFileName(path:string):string {
        path = LoadUtils.urlPathFilter(path);
