...
export class UdSeqSorter {
     ...
     */
    public static sortParser<T>(list:UdSeqList<T>, name:string, type:UdSortDir, compareFun:(a:T, b:T, name:string)=>number, sortList?:number[]) {
     ...
     */
    public static updateSort<T>(list:UdSeqList<T>, name:string, sortList?:number[]):number[] {
        if (sortList == null) {
            sortList = [];
