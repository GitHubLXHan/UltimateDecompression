...
@ccclass
export abstract class UdViewMotion extends cc.Component {

    @property({ type: cc.Enum(UdEaseKind) })
    openEase: UdEaseKind = UdEaseKind.OutCirc;
    ...
    @property({ type: cc.Enum(UdEaseKind) })
    closeEase: UdEaseKind = UdEaseKind.InCirc;
