import { LogMgr } from "../../extension/log/LogMgr";
import { LoadUtils } from "../../extension/utils/LoadUtils";

export class ResPathUtils {
	...
	private static _horsePath: string = "model/horse/";
	private static _fashionPath: string = "fashion/";
	...
	public static init(rootPath: string) {
		if (rootPath != null && rootPath.length > 0) {
			this._rootPath = LoadUtils.urlPathFilter(rootPath);
		}
	}
